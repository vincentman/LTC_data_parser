...
if __name__ == '__main__':
    ...
    for file_name_year in file_name_years:
        ...
        data_path_year = path.join(config.data_serialized_path, year, f'{year}_serialized.pickle')
        if not path.exists(data_path_year):
            ...
            print('reading data pickle..... => ', data_path_year)
    ...
    print('Elapsed time(sec) for select_sample_old: ', end - start)
